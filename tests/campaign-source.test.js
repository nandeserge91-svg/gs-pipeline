...
test('les autres produits Google Sheet ne sont pas reclassés', () => {
...
test('les statistiques reconnaissent TikTok, Facebook et les autres sources', () => {
  ...
  assert.equal(classifyOrderTrafficSource({ campaignSource: 'Google Sheet - Bee Venom' }), 'other');
});
